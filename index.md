        ...
        <div class="md:flex-shrink-0 p-8 md:p-12 md:w-1/3 flex flex-col items-center justify-center text-center bg-gray-900 text-white">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-center md:justify-start space-x-4">
                    <a href="https://www.linkedin.com/in/santiago-figueroa-rodriguez/" target="_blank" class="flex items-center space-x-1 text-indigo-300 hover:text-indigo-100 transition duration-300">
